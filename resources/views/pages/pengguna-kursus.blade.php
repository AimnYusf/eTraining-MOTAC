...
@section('content')
  ...
  <div class="card">
    ...
    <div class="course-table">
      ...
      <tbody id="katalog-kursus" class="row">
  ...
  <script>
    ...
    const el = document.getElementById('katalog-kursus');
    if (!el) return;

    el.classList.remove('row-cols-3', 'row-cols-4');
    el.classList.add(getPageLengthByResolution());
    }

    document.addEventListener('DOMContentLoaded', applyResponsiveRowCols);
    window.addEventListener('resize', applyResponsiveRowCols);
  </script>

...
@section('content')
  ...
  <div class="card">
    ...
    $pemohon = [
      ...
      'Kementerian/Jabatan/Agensi' => $pengguna->etraJabatan->jab_ketpenu,
      'Bahagian' => $pengguna->pen_idbahagian ? $pengguna->etraBahagian->bah_ketpenu : $pengguna->pen_bahagianlain,

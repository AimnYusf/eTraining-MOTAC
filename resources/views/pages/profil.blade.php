          ...
          <div class="row mb-5">
            ...
            <div class="col-md-9">
              <select id="pen_idkumpulan" class="selectpicker w-100" name="pen_idkumpulan" data-style="btn-default"
                ...
                @if ($item->kum_ketpenu != 'Terbuka')
                <option value="{{ $item->kum_id }}" {{ isset($pengguna->pen_idkumpulan) && $pengguna->pen_idkumpulan == $item->kum_id ? 'selected' : '' }}>{{ $item->kum_ketpenu }}</option>
                @endif
                @endforeach
              </select>
            </div>

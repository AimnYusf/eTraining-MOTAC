...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="{{ url('/') }}" class="app-brand-link d-flex align-items-center">
      <img src="{{ asset('images/logo-kementerian.png') }}" alt="Logo" class="app-brand-logo demo me-2"
        style="height: 30px;">
  ...
  <ul class="menu-inner py-1">
    ...
    'administrator' => in_array($menu->slug, ['dashboard', 'kursus', 'permohonan', 'isytihar', 'rekod-kursus', 'profil', 'pentadbir', 'urusetia-kursus', 'urusetia-permohonan', 'urusetia-kehadiran',
    'laporan', 'laporan-kumpulan', 'laporan-ringkasan', 'laporan-keseluruhan', 'laporan-individu',
    'tetapan', 'tetapan-tempat',
    'urusetia-pengguna']),

...
@section('page-script')
  @vite([
    'resources/assets/js/tetapan-bahagian.js'
  ])
@endsection
  ...
  <div class="modal fade" id="crudModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      ...
      <div class="text-center mb-6">
        <h4 id="bah_tajuk" class="mb-2"></h4>
        <hr>
      </div>
      <form id="crudForm" class="row g-6">
        @csrf
        <input type="hidden" id="bah_id" name="bah_id">
        <div class="col-12">
        <label class="form-label" for="bah_ketpenu">Nama Bahagian</label>
        <input type="text" id="bah_ketpenu" name="bah_ketpenu" class="form-control" placeholder="Nama Bahagian" />
        </div>
        <div class="col-12">
